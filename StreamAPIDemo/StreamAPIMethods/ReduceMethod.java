...
public class ReduceMethod {
    public static void main(String[] args) {
        ...
        System.out.println("4   72   104");

        // Use reduce() method to get the last output
        // With this logic, it will perform addition of all the elements from the previous stream S2
        int result = s3.reduce(0, (c,e) -> c+e);
        System.out.println("Output of reduce() method: " + result);
    }
}
